package com.muqit.kharredovendorpanel.Adapters;
...
import com.muqit.kharredovendorpanel.R;
        ...
        public FilterResults performFiltering(CharSequence charSequence) {
            ...
            if (charSequence == null || charSequence.length() == 0 || charSequence.equals("")) {
                ...
                for (VendorsData vendorsData : VendorsRecyclerViewAdapter.this.vendorsDataArrayListFullList) {
                    if (blankIfNull(vendorsData.getEmail()).toLowerCase().contains(trim) ||blankIfNull(vendorsData.getFirstName().toLowerCase() + " " + vendorsData.getLastName().toLowerCase()).contains(trim) || blankIfNull(vendorsData.getDate_Created()).toLowerCase().contains(trim)) {
